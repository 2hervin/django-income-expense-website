...
SECRET_KEY = 'django-insecure-h(h%(t0+%p=nt&irkb(fqj-3ivc1r$hmq$cw3m9#x=z*0v46ls'
...
EMAIL_HOST_USER= os.environ.get('munyanzizahervin@gmail.com')
EMAIL_USE_TLS= True
DEFAULT_FROM_EMAIL = os.environ.get('munyanzizahervin@gmail.com')
EMAIL_PORT = 587
EMAIL_HOST_PASSWORD = os.environ.get('gmail33199')
